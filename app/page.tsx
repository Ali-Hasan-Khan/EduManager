  ...
  return (
    <main className="flex min-h-screen flex-col p-6 bg-black bg-grid-small-white/[0.2] overflow-hidden">
      <div className="mt-4 flex-grow flex flex-col gap-4 md:flex-row">
        ...
        <div className="flex flex-col shadow-xl justify-end gap-6 rounded-lg bg-gray900 border border-gray800 px-6 py-4 md:w-4/5 md:px-4 xsm:px-[125px] 2xsm:px-[100px]">
          <ImagesSliderDemo />
        </div>
